...
namespace MobileTestTask.PageObjects.IOSPageObjects
{
    ...
    //    public class BasePage:Page
    {
        ...
        public CorePageObject(AppiumDriver<IWebElement> driver)
        {
            Wait = new Utils.Wait { Timeout = TimeSpan.FromSeconds(2) };
            _driver = driver;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            Wait.Until(() => webElement.Displayed, TimeSpan.FromSeconds(timeoutnSeconds));
            return webElement;
        }
        ...
        public IWebElement WaitForElementAndSendKeys(IWebElement webElement, string text, int timeoutnSeconds)
        {
            var element = WaitForElementPresent(webElement, timeoutnSeconds);
            try
            {
